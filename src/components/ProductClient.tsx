...
<button
                                        ...
                                        className="h-[45px] bg-[#db0f70] text-white rounded-[5px] font-bold text-[14px] hover:bg-[#8f16a7] transition-all flex items-center justify-center gap-3 shadow-xl active:scale-95 border-b-2 border-[#8a0339]/50 px-4"
                                    >
                                ...
                                <div className="bg-green-50/50 border border-green-100 rounded-[20px] p-5 flex items-center gap-4 text-green-900 shadow-sm">
                                    ...
                                    <div className="text-[12.5px] font-bold leading-tight">
                                        ...
                                        <span className="text-green-500/60 font-medium">Recíbelo en 24-48 horas en todo el país.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
