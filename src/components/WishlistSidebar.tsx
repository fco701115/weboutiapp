                    ...
                    <div className="flex-grow overflow-y-auto px-6 py-4 space-y-6 custom-scrollbar">
                                    ...
                                    <div className="flex flex-col flex-grow justify-between py-1">
                                        ...
                                        <div className="flex items-center justify-between mt-auto">
                                            <button
                                                ...
                                                className="flex items-center gap-2 text-[12px] font-bold text-[#198754] hover:text-slate-900 transition-colors uppercase tracking-wider"
                                            >
                        ...
                        {showAddToast && (
                            <div className="fixed bottom-24 right-4 left-4 md:left-auto md:w-80 z-[1002] animate-in slide-in-from-bottom-4 fade-in duration-300">
                                <div className="bg-[#198754] text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 border border-white/20 backdrop-blur-md">
