            ...
            <div className="min-h-screen bg-[#f7f9fa] flex items-center justify-center p-6">
                <div className="w-full max-w-md bg-white rounded-[40px] p-12 text-center shadow-2xl border border-slate-100 animate-in zoom-in duration-500">
                    ...
                    <div className="mt-8 flex justify-center">
                        <div className="w-8 h-8 border-4 border-[#1a3da1]/20 border-t-[#1a3da1] rounded-full animate-spin" />
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-[#f7f9fa] flex items-center justify-center p-6">
            <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[48px] shadow-2xl overflow-hidden border border-slate-100">
                ...
                {/* Visual Side */}
                <div className="hidden lg:flex bg-[#124baf] p-16 flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <Link href="/" className="text-white text-4xl font-black tracking-tighter mb-12 block">
                            Dazlea<span className="text-blue-400">.</span>
                        </Link>
                    ...
                    <div className="relative z-10 pt-10 border-t border-white/10">
                        <p className="text-blue-200/50 font-medium text-sm">© 2026 Dazlea Technologies. All rights reserved.</p>
                    </div>
                </div>
                ...
                <div className="p-8 md:p-12 flex flex-col justify-center max-h-[100vh] overflow-y-auto">
                    <div className="mb-8">
                        <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-[#1a3da1] mb-6">
                            <UserIcon size={24} />
                        </div>
                        <h1 className="text-[32px] font-black text-slate-900 tracking-tighter mb-2">Crear Cuenta</h1>
                        <p className="text-slate-400 font-medium">Sé parte de la comunidad tech de Dazlea.</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full h-12 pl-12 pr-4 bg-slate-50 border border-slate-100 rounded-2xl font-bold focus:ring-4 ring-blue-500/5 transition-all outline-none"
                                />
                            </div>
                        </div>
                        ...
                        <button
                            disabled={isLoading}
                            className={`w-full h-14 rounded-2xl font-black text-[14px] uppercase tracking-widest transition-all flex items-center justify-center gap-3 shadow-xl ${isLoading ? 'bg-slate-100 text-slate-400' : 'bg-[#124baf] text-white hover:bg-slate-900 active:scale-95 shadow-blue-500/10'}`}
                        >
                    ...
                    <p className="mt-8 text-center text-slate-400 font-medium text-sm">
                        ¿Ya tienes cuenta? <Link href="/login" className="text-[#1a3da1] font-black hover:underline">Inicia Sesión</Link>
                    </p>
                </div>
            </div>
        </div>
